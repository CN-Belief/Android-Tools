...
{
    int choice;
    cout<<"****************************************************************"<<endl<<endl<<"酷安:WF_Belief 吾爱:辰某"<<endl<<"1.本程序完全免费 如您是购买所得 请立即退款"<<endl<<"2.使用前，请备份好数据，以防出现问题"<<endl<<"3.使用本程序则代表您同意接受可能带来的风险,如:数据丢失、卡米等"<<endl<<endl<<"****************************************************************"<<endl<<endl<<"本程序发布前已经过测试，但不保证您使用过程中不会出现意外情况，如有BUG或意见，欢迎私信作者反馈"<<endl;
    cout<<"如您的手机是开机卡第一屏(即开机时有开机动画，但无法进入系统)那您可以使用此程序进行救砖"<<endl<<"请在手机处于开机动画时连接电脑，并使用本程序"<<endl<<"继续请按回车"<<endl;
    getchar();
    system("adb devices");
